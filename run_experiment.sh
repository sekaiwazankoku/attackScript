...
exp_tag="rate[$pkts_per_ms]-delay[$delay_ms]-buf_size[$buf_size_bdp]-cca[$cca]-delay_budget[$delay_budget]-mode[$mode]"
...
mm-delay $delay_ms \
        mm-copa-attack $delay_budget $uplink_link_logfilepath $downlink_link_logfilepath $uplink_attack_logfilepath $downlink_attack_logfilepath \
        $SCRIPT_PATH/bottleneck_box.sh
